...
import {CollapsibleList, ListDivider, SimpleListItem, ListOnActionEventT, ListItem} from '@rmwc/list'
            ...
            <>
                ...
                <div className="main-container">
                    <div className="sidebar-container">
                        <Sidebar onUploadClicked={(event: ListOnActionEventT) => {this.toggleModal("upload")}}/>
                    </div>
